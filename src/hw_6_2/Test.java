...
// after adapting it to remain the stored elements unchanged
...
public class Test {
    ...
    public static void testCelestialBody()        {
        StorageOfAstronomicalObject<CelestialBody> aStorageOfAstronomicalObject = new StorageOfAstronomicalObject<>("Milky Way");
